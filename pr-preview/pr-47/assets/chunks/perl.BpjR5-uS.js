import{g as o}from"./commonjsHelpers.BosuxZz1.js";function $(s,i){for(var t=0;t<i.length;t++){const n=i[t];if(typeof n!="string"&&!Array.isArray(n)){for(const e in n)if(e!=="default"&&!(e in s)){const p=Object.getOwnPropertyDescriptor(n,e);p&&Object.defineProperty(s,e,p.get?p:{enumerable:!0,get:()=>n[e]})}}}return Object.freeze(Object.defineProperty(s,Symbol.toStringTag,{value:"Module"}))}var r={exports:{}};(function(s,i){ace.define("ace/snippets/perl.snippets",["require","exports","module"],function(t,n,e){e.exports=`# #!/usr/bin/perl
snippet #!
	#!/usr/bin/env perl
